...
const itineraryData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "飯店步行 3 分鐘即達之釜山站必吃老店，每碗約 9,000 韓元（約 NT$ 216），湯頭濃郁鮮美，附新鮮韭菜與蝦醬。",
        icon: "🍲",
        badges: ["老字號湯飯", "避開尖峰"],
        badgeType: "food",
      ...
      {
        time: "18:30 - 20:30",
        title: "晚餐：味贊王鹽烤肉 (맛찬들왕소금구이 南浦店)",
        desc: "享用 3.5cm 超厚切熟成豬五花與豬頸肉（人均約 NT$ 480-600），專人桌邊代烤，外酥內嫩！",
        icon: "🥩",
        badges: ["厚切熟成豬", "專人代烤"],
        badgeType: "food",
        transport: "🚶 光復路商圈步行 3 分鐘 (費用 ₩0)",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=Matchandeul+Wangso-geum-gui+Nampo"
      },
      {
        time: "20:30～",
        title: "返回飯店休息與早睡補眠",
  ...
  },
  {
    ...
    items: [
      ...
      {
        time: "18:45 - 20:30",
        title: "晚餐：西面豬肉湯飯街 松亭3代豬肉湯飯",
        desc: "一日遊於西面站下車（或選擇直接回釜山站休息）。享用 30 年老字號湯飯（每碗約 NT$ 216），飯後感受西面商圈熱鬧氛圍。",
        icon: "🍲",
        badges: ["老字號湯飯", "西面美食"],
        badgeType: "food",
        transport: "🚌 專車直達西面下車 / 🚇 回飯店地鐵 1 號線 (車資 ₩1,600/人 / 約 NT$ 38)",
  ...
  },
  {
    day: 3,
    date: "8/11（二）",
    subTitle: "水晶纜車 · 帝王蟹 · 百貨大採購",
    title: "松島水晶纜車&龍宮雲橋 ➔ 札嘎其帝王蟹饗宴 ➔ 樂天百貨與樂天超市大採購 ➔ BIFF 廣場小吃漫遊",
    items: [
      {
        time: "10:00 - 12:15",
      ...
      {
        time: "12:30 - 14:30",
        title: "午餐：札嘎其海鮮市場 / 新東亞水產市場 帝王蟹饗宴",
        desc: "8 人建議點 2 隻大帝王蟹 (約 4.5-5.5kg)，搭配店家招待鮑魚、扇貝、生章魚與蟹膏炒飯。🏆【渡邊水產 100/101號 (上2樓看港景，配菜最豪邁)】 vs 【新東亞 8號攤位 (1樓直接吃免代客費，華僑老闆溝通親切無壓力)】。<br><br><button class='map-link-btn' onclick='switchSection(\"crab-section\")' style='background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%) !important; color: #fff !important; font-weight: 700; margin-top: 0.4rem; font-size: 0.85rem;'><i class='fa-solid fa-utensils'></i> 🦀 查看【渡邊水產 vs 新東亞8號】8人帝王蟹完整對比表 ➔</button>",
        icon: "🦀",
        badges: ["渡邊水產100號", "新東亞8號", "紅帝王蟹6刺"],
        badgeType: "food",
...
// Olive Young 必買商品 20 款完整資料集
const oyProductsData = [
  {"id": "mediheal", "time": "01:37", "name": "MEDIHEAL 精華面膜片", "en_name": "MEDIHEAL Essential Mask", "category": "skincare", "category_zh": "臉部護理", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1712/a1d9ea92-30e9-4d90-82a3-5e67567590a2.png", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA250128210", "features": "高濃度精華、服貼度高、高CP值", "skin_type": "所有膚質，特別是缺水肌與需要曬後鎮靜者", "reason": "金針菇姐姐強烈推薦的國民面膜。精華液含量極高，面膜紙薄且貼合度優秀。在 Olive Young 購買通常有 10 片一盒的包裝，並且常常有 1+1 (買一送一) 的促銷活動，是去韓國必囤的保濕聖品。", "tips": "建議洗完臉後敷 10-15 分鐘，取下後輕輕按摩至吸收，再擦上乳液鎖水。若有醫美術後泛紅，綠色積雪草款是很好的鎮靜選擇。"},
  {"id": "biodance", "time": "03:25", "name": "Biodance 膠原蛋白深層全效面膜", "en_name": "Biodance Bio-Collagen Real Deep Mask", "category": "skincare", "category_zh": "臉部護理", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1842/83f09b5b-60f3-4a5d-949e-856c3d8dc71b.jpg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA230418238", "features": "水凝膠材質、敷完變透明、深層彈力", "skin_type": "乾性肌、熟齡肌、暗沉無光澤肌", "reason": "近期紅遍全球的「敷著睡覺面膜」。它是果凍般的水凝膠材質，敷上後面膜中的超低分子玻尿酸與膠原蛋白會慢慢被肌膚吸收，面膜會隨時間變為完全透明。能顯著改善毛孔與提亮膚色。", "tips": "適合在夜間保養的最後一步使用，建議敷 3-4 小時以上（甚至敷著入睡），醒來後撕下即可看見驚人的水光感與澎潤肌膚。", "badge": "熱銷斷貨王"},
  {"id": "torriden", "time": "Klook推薦", "name": "Torriden 5D微分子玻尿酸保濕精華", "en_name": "Torriden Dive-In Low Molecular Hyaluronic Acid Serum", "category": "skincare", "category_zh": "臉部護理", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1804/d39c6c3c-ff54-47a7-b8da-b7687258c131.png", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA230920410", "features": "5重玻尿酸、秒速補水、清爽不黏", "skin_type": "油性肌、混合肌、極度缺水乾燥肌", "reason": "Klook 激推的補水第一名精華！在 Olive Young 連續多年榮獲精華類大賞第一名。含有5種不同分子大小的玻尿酸，能深層滲透肌膚底層，瞬間解渴。質地如水般清爽，吸收後完全不黏膩，是極致的補水神器。", "tips": "洗完臉後，在化妝水後使用 1-2 滴輕拍至全臉吸收，後續疊加面霜鎖水。夏日曬後可厚塗做修護。", "badge": "霸榜精華王"},
  {"id": "manyo", "time": "Klook推薦", "name": "ma:nyo 魔女工廠 純淨潔顏油", "en_name": "ma:nyo Pure Cleansing Oil", "category": "skincare", "category_zh": "臉部清潔", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1153/7a8ff368-1d2f-4ee9-915a-744f52d92fd8.jpg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA210000733", "features": "天然植物油、秒乳化、溫和卸妝", "skin_type": "所有膚質、易長黑頭粉刺肌", "reason": "Klook 批踢踢極力推薦，Olive Young 長年霸榜的國民卸妝油！採用 99.9% 自然衍生植物油成分，溫和不熏眼。遇水瞬間乳化，不僅能徹底卸除濃妝與防曬，更能透過打圈按摩溫和軟化毛孔中的黑頭與髒污。", "tips": "乾手乾臉塗抹全臉按摩，再沾取少量溫水使其完全「乳化」變白，輕柔按摩 30 秒後以溫水徹底洗淨。", "badge": "回購率No.1"},
  {"id": "aestura", "time": "Klook推薦", "name": "AESTURA Atobarrier 365 舒緩保濕乳霜", "en_name": "AESTURA Atobarrier 365 Cream", "category": "skincare", "category_zh": "臉部護理", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1048/80ed7799-c56a-4351-a814-16097ad1a702.jpg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA240121573", "features": "專利保濕膠囊、修護屏障、舒緩過敏", "skin_type": "敏感肌、乾性肌、肌膚壓痛/紅腫/泛紅者", "reason": "Klook 激推敏感肌救星！由愛茉莉太平洋集團推出的醫學美容護膚品牌。乳霜中含有肉眼可見的專利「Atobarrier」微小保濕膠囊，抹開後迅速融化並形成鎖水膜，修護因過敏或乾燥而受損的肌膚屏障。", "tips": "在護膚最後一步塗抹，特別適合在寒冷季節或搭飛機、乾冷國家時做深層鎖水防護。", "badge": "敏感肌神霜"},
  {"id": "unove", "time": "Klook推薦", "name": "UNOVE 深層受損修護髮膜", "en_name": "UNOVE Deep Damage Treatment EX", "category": "body", "category_zh": "身體保養", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1367/8d2557d0-8bee-447a-9269-46e80a5c598c.png", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA220916169", "features": "高濃度蛋白質、沙龍級修護、香氣迷人", "skin_type": "受損髮質、染燙後毛躁分岔、粗糙無光澤髮質", "reason": "Klook 強力推薦，去韓國必囤的沙龍級髮品！Dr.FORHAIR 旗下專攻受損髮的品牌。富含 30,000ppm 高濃度蛋白質，能瞬間撫平毛躁，讓頭髮恢復絲滑柔順的光澤，香氣是溫柔的法式玫瑰與麝香。", "tips": "洗髮後稍微擰乾水分，塗抹於髮尾處並靜置 2-3 分鐘後徹底沖洗，每週使用 2-3 次即可達到深層護髮效果。", "badge": "護髮斷貨王"},
  {"id": "dokdo", "time": "Klook推薦", "name": "Round Lab 1025 獨島化妝水", "en_name": "Round Lab 1025 Dokdo Toner", "category": "skincare", "category_zh": "臉部護理", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1832/bad00944-4a2c-40c3-be9b-7adc90de484f.jpg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA210002228", "features": "鬱陵島深海水、溫和角質調理、補水清透", "skin_type": "所有膚質，包括敏感肌與易泛紅肌膚", "reason": "Klook 經典推薦！採用鬱陵島深層海水配方，富含 72 種天然礦物質，質地溫和清爽。含有專利去角質酵素，能在日常擦拭中溫和代謝老廢角質，恢復肌膚的細緻亮透。", "tips": "適合搭配化妝棉使用。每天早晚潔面後，用浸濕的化妝棉由內向外順著肌膚紋理輕輕擦拭，也可用於濕敷。", "badge": "獨島系列明星"},
  {"id": "bagel_chip", "time": "Klook推薦", "name": "Delight Project 貝果脆片", "en_name": "Delight Project Bagel Chip", "category": "lifestyle", "category_zh": "健康飲品", "img_url": "https://cdn-image.oliveyoung.com/display/goods/40/30/30/00/GA2023121516091.jpg", "raw_img": "https://global.oliveyoung.com/search?query=Delight+Project+Bagel+Chip", "features": "低卡低熱量、慢火烘焙、超人氣辦公室零食", "skin_type": "喜愛零嘴但注重身材管理與低卡健康飲食者", "reason": "Klook 伴手禮極力推薦！Olive Young 的明星自有零食品牌。將真實貝果切片後塗抹奶油慢火烘焙，口感極其酥脆，有蒜香奶油、蜂蜜奶油與披薩等多種口味，熱量極低且飽足感強。", "tips": "極度推薦搭配 Teazen 康普茶一起享用，作為下午茶或宵夜，解饞又完全沒有罪惡感！", "badge": "收銀台秒殺款"},
  {"id": "beyond", "time": "04:14", "name": "Beyond 美白乳液 / 身體乳", "en_name": "Beyond Body Emulsion", "category": "body", "category_zh": "身體保養", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1623/bd956629-e7f9-4200-8b0b-0209481aa600.jpg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA210711216", "features": "溫和草本、高級白麝香、深層鎖水", "skin_type": "所有膚質、身體肌膚乾燥脫屑者", "reason": "LG 生活健康旗下的環保自然品牌。這款身體乳以療癒且高級的「白麝香」香氣聞名，質地乳爽不黏膩，保濕度極佳，能修護乾燥的肌膚屏障。", "tips": "每天洗澡後，在身體微濕時塗抹，保濕與持香效果最佳。"},
  {"id": "yunjac", "time": "05:27", "name": "Yunjac 然植亞保濕底霜 (Base Prep)", "en_name": "Yunjac Skin Perfecting Protective Base Prep", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "https://cdn-image.oliveyoung.com/display/1544/a666b901-caf2-4cef-bc98-ffd1d202b29c.jpg", "raw_img": "https://global.oliveyoung.com/global/brands/yunjac", "features": "底妝膠水、防護隔離、透亮光澤", "skin_type": "乾性肌、混合偏乾、底妝容易浮粉起皮者", "reason": "高端草本護膚品牌推出的妝前精華。被譽為「乾皮親媽」與「化妝師的秘密武器」，質地如水般輕盈，能迅速覆平臉部角質，讓後續不論是粉底液還是氣墊粉餅都非常貼合，展現高級的水光感。", "tips": "在防曬後、底妝前，取 2-3 滴均勻塗抹於全臉，特別是易卡粉的鼻翼與兩頰，輕拍至微黏狀態再上底妝。", "badge": "美妝大賞第一"},
  {"id": "obge", "time": "06:13", "name": "OBgE 自然防曬棒", "en_name": "OBgE Natural Cover Sun Stick", "category": "skincare", "category_zh": "防曬護理", "img_url": "https://cdn-image.oliveyoung.com/display/1309/1738d4e6-3267-494c-8f68-72eabe75ec38.jpg", "raw_img": "https://global.oliveyoung.com/global/brands/obge", "features": "不沾手、清爽控油、不泛白", "skin_type": "所有膚質、混合偏油、男士、喜愛戶外活動者", "reason": "韓國男士理容第一品牌推出的防曬棒，女生也非常愛用！具備 SPF50+/PA++++ 最高防曬規格。棒狀設計極為方便，完全不沾手，上臉後呈乾爽霧面，且完全不泛白、不黏膩，抗汗效果優秀。", "tips": "適合隨身攜帶，在戶外每 2-3 小時隨時塗抹補防曬。因其清爽度高，妝後輕拍補防曬也不易弄髒妝容。"},
  {"id": "the_saem", "time": "07:12", "name": "The Saem 得鮮完美遮瑕液", "en_name": "The Saem Cover Perfection Tip Concealer", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "https://cdn-image.oliveyoung.com/display/1744/87a3e29c-58d0-4623-9468-7e467f09c279.jpg", "raw_img": "https://global.oliveyoung.com/global/brands/the-saem", "features": "極高遮瑕力、平價戰神、多色號選擇", "skin_type": "有痘疤、黑眼圈、班點需要高度遮瑕者", "reason": "風靡亞洲的平價遮瑕天王。遮瑕力強、持妝度極佳，不論是多深的痘疤 or 黑眼圈，輕點一下就能完美遮蓋，CP 值高到不可思議。", "tips": "因遮瑕力極高，質地偏乾，建議局部「點」在瑕疵處，等 10 秒微乾後，再使用濕海綿或粉撲邊緣輕輕拍開。"},
  {"id": "about_tone", "time": "08:40", "name": "About Tone 柔焦控油蜜粉餅", "en_name": "About Tone Blur Powder Pact", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1386/666d04e9-7037-4b1c-ad8c-317ddca203f4.jpg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA250933463", "features": "一秒磨皮、粉質極細、強效控油", "skin_type": "油性肌、混合肌、毛孔粗大者", "reason": "前身為風靡韓國的 Eglips 蜜粉餅。這款粉餅主打「空氣柔焦」效果，粉質如輕煙般細緻，能瞬間吸附皮脂，讓毛孔隱形，打造如陶瓷娃娃般的乾淨霧面妝效。", "tips": "使用附帶的粉撲，在底妝後輕壓在容易出油的 T 字部位、鼻翼，或用於眼周打底防暈染。"},
  {"id": "so_natural", "time": "09:55", "name": "So Natural 經典定妝噴霧", "en_name": "So Natural All Day Tight Makeup Setting Fixer", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "https://cdn-image.oliveyoung.com/display/goods/40/30/30/00/GA2023121516091.jpg", "raw_img": "https://global.oliveyoung.com/search?query=So+Natural+Setting+Fixer", "features": "細緻霧化、快速成膜、抗摩擦防脫妝", "skin_type": "所有膚質、混合偏油、需要長時間持妝者", "reason": "韓國定妝噴霧界的常勝冠軍，粉紅色瓶身非常具有代表性。其壓頭噴出的水霧極其細緻，不會在臉上結成水珠，能快速在底妝上形成保護膜，抗汗、抗油且防摩擦。", "tips": "化妝完成後，將噴霧距離臉部 20-30 公分，畫 'X' 和 'T' 字形噴灑全臉，靜待 1 分鐘自然風乾成膜，切勿用手拍打。"},
  {"id": "canmake", "time": "10:30", "name": "Canmake 腮紅霜", "en_name": "Canmake Cream Cheek", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "https://cdn-image.oliveyoung.com/display/goods/40/30/30/00/GA2023121516091.jpg", "raw_img": "https://global.oliveyoung.com/search?query=Canmake+Cream+Cheek", "features": "清透血色感、凝膠轉粉質、白裡透紅", "skin_type": "所有膚質，尤其是喜愛無粉感日韓系妝容者", "reason": "雖然是日系彩妝，但其極佳的自然融膚感在韓國 Olive Young 也擁有超高人氣。凝膠般的質地上臉推開後會化為乾爽的粉質，呈現如皮膚底層自然透出來 of 紅潤氣色。", "tips": "用手指沾取適量，輕點於蘋果肌處往外拍開，或是用氣墊粉撲上妝，效果更加均勻清透。"},
  {"id": "fillimilli", "time": "11:38", "name": "Fillimilli 胖胖氣墊粉撲", "en_name": "Fillimilli Cushion Pang Pang Puff", "category": "tools", "category_zh": "美妝工具", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1239/a3f66b06-8dfa-4799-af4a-e172052f79a7.png", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA250933686", "features": "厚實有彈性、上妝服貼、省時省粉底", "skin_type": "所有使用氣墊粉餅或粉底液的化妝者", "reason": "Olive Young 自有美妝配件品牌 Fillimilli 的明星產品。這款氣墊粉撲非常厚實，彈性極佳，能將粉底均勻且輕薄地拍入肌膚，大幅提升底妝的服貼度，是去 OY 必抓好幾個回台的貼心小物。", "tips": "可用於氣墊粉餅，也適合搭配普通粉底液使用。上妝時採用「快速拍打」的方式，能讓妝效更具光澤與遮瑕力。"},
  {"id": "too_cool", "time": "12:43", "name": "Too Cool for School 美術課修容/腮紅 #14", "en_name": "Too Cool for School Artclass Shading", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1274/c98aa803-7c7b-4070-9b46-598ca60ef0db.jpeg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA240121736", "features": "發色自然、柔滑粉質、不易失手", "skin_type": "彩妝新手、喜愛溫柔日常妝容者", "reason": "Too Cool for School 的經典美術課系列，以極佳的發色與粉質著稱。#14 號色提供了極為溫柔、自然且符合亞洲人膚色的冷暖平衡色調，不易結塊且能完美修飾臉部輪廓。", "tips": "用修容刷或腮紅刷沾取後，在手背上稍微拍掉多餘粉末，再輕刷於臉頰或下顎線，可少量多次疊加。"},
  {"id": "peripera", "time": "14:09", "name": "Peripera 水光唇釉 (Ink Mood Glowy)", "en_name": "Peripera Ink Mood Glowy Tint", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1906/ca69779e-539b-4ea9-8105-9cb5de677c00.jpg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA231121205", "features": "玻璃水光感、滋潤修飾唇紋、持久顯色", "skin_type": "唇紋明顯、喜愛水光嘟嘟唇與純欲妝效者", "reason": "平價彩妝之王 Peripera 的明星水光唇釉。上嘴後會形成一層晶瑩剔透的水光膜，質地保濕不乾澀，且帶有輕微的染唇效果，不容易完全掉色，是打造網紅玻璃唇的首選。", "tips": "塗抹於雙唇後，**靜待 1-2 分鐘不要抿嘴**，等它自動成膜後，水光感和持久度會大幅提升。"},
  {"id": "banila_co", "time": "15:14", "name": "Banila Co 緻柔卸妝膏", "en_name": "Banila Co Clean It Zero Cleansing Balm", "category": "skincare", "category_zh": "臉部清潔", "img_url": "https://cdn-image.oliveyoung.com/prdtImg/1259/d5014b07-17a4-4898-a86d-32925dc66aa8.jpg", "raw_img": "https://global.oliveyoung.com/product/detail?prdtNo=GA260439352", "features": "雪酪質地、秒乳化、溫和不緊繃", "skin_type": "所有膚質，包括敏感肌與日常化濃妝者", "reason": "風靡全球的「國民卸妝膏」。雪酪般的固體質地，接觸體溫後會瞬間融化並乳化，能溫和、徹底地卸除所有頑固的防水彩妝與毛孔髒污，且洗後完全不熏眼、不緊繃。", "tips": "保持雙手和臉部乾燥，取適量卸妝膏塗抹於臉部輕柔按摩打圈，再沾取少量清水使其完全「乳化」變白，最後用溫水徹底沖洗乾淨。"},
  {"id": "teazen", "time": "16:29", "name": "Teazen 康普茶 (Kombucha)", "en_name": "Teazen Kombucha", "category": "lifestyle", "category_zh": "健康飲品", "img_url": "https://cdn-image.oliveyoung.com/display/1366/d4954a5a-4b16-44cb-8799-7a935df33404.jpg", "raw_img": "https://global.oliveyoung.com/global/brands/teazen", "features": "低卡無糖、富含益生菌、清爽氣泡感", "skin_type": "注重腸道健康、想戒含糖飲料的健康追求者", "reason": "因為 BTS 成員飲用而火遍全韓的健康機能飲品。採用凍乾技術保留乳酸菌與益生元，沖泡後帶有碳酸微氣泡感，口味酸甜清爽（如檸檬、水蜜桃等），一包熱量僅 15 卡，解膩無負擔。", "tips": "用 250ml - 500ml 的冷水或冰水沖泡，氣泡感會更加強烈，喝起來就像健康的汽水，非常適合作為大餐後的消食飲料。"}
];
...
function renderOliveYoung(filterCategory = 'all') {
  ...
  oyProductsData.forEach(p => {
    ...
    count++;
    const targetUrl = p.raw_img || `https://global.oliveyoung.com/search?query=${encodeURIComponent(p.name)}`;
    html += `
      <div class="product-card" style="background: var(--bg-card); border: 1px solid var(--border-light); border-radius: var(--radius-md); padding: 1.25rem; display: flex; flex-direction: column; gap: 0.75rem;">
        <div class="oy-thumb-container" style="position: relative; border-radius: 8px; overflow: hidden; height: 180px; background: #fff;">
          <img src="${p.img_url}" alt="${p.name}" style="width: 100%; height: 100%; object-fit: contain; padding: 10px;" onerror="this.src='https://images.unsplash.com/photo-1556228720-195a672e8a03?q=80&w=600&auto=format&fit=crop'">
        </div>
        ...
        <a href="${targetUrl}" target="_blank" rel="noopener" class="map-link-btn" style="margin-top: auto; text-align: center; justify-content: center;">
          <i class="fa-solid fa-bag-shopping"></i> 前往官方商品頁 🔗
        </a>
      </div>
    `;
  });
