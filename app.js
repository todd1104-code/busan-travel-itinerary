...
const itineraryData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "第一天剛抵達，選擇清爽溫補的海帶湯（牛肉/鮑魚海帶湯）或 50 年老字號「南浦蔘雞湯」暖胃養生，減輕剛下飛機的腸胃負擔與疲勞！<br>💡<b>【備案】</b>：亦可選擇「李재모披薩 (Lee Jae Mo Pizza)」享受在地人最愛的起司披薩。",
        icon: "🍲",
        badges: ["第一天清爽暖胃", "溫補養生", "五福海帶湯/蔘雞湯"],
        badgeType: "food",
        transport: "🚶 光復路商圈步行 3 分鐘 (費用 ₩0)",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=Obok+Miyeok+Nampo+Busan"
      },
      {
        time: "20:30～",
        title: "返回飯店休息與早睡補眠",
  ...
  },
  {
    day: 3,
    date: "8/11（二）",
    subTitle: "水晶纜車 · 雙方案午餐 · 百貨採購 · 味贊王極致燒肉",
    title: "松島水晶纜車&龍宮雲橋 ➔ 札嘎其市場(雙方案:帝王蟹 VS 烤海鮮/石鍋拌飯) ➔ 樂天百貨與超市大採購 ➔ 味贊王鹽烤肉盛宴 ➔ BIFF 廣場",
    items: [
      {
        time: "10:00 - 12:15",
      ...
      },
      {
        ...
        desc: "百貨商場內舒適購物冷氣充裕，可登上 13 樓免費屋頂庭園俯瞰釜山港與影島大橋景致。",
        icon: "🏙️",
        badges: ["樂天百貨", "屋頂庭園觀景"],
        badgeType: "shop",
      ...
      {
        time: "19:00 - 20:45",
        title: "晚餐饗宴：味贊王鹽烤肉 富平店 (맛찬들왕소금구이 부평점)",
        desc: "【黃金精華燒肉時段！】採買完伴手禮後，步行 3~5 分鐘至富平店（札嘎其站 3 號出口新址）。享用 3.5cm 超厚切熟成豬五花與豬頸肉，專人桌邊代烤外酥內嫩！<br>💡<b>【備案】</b>：若人潮過多，可順走前往「河南豬肉家 南浦店 (하남돼지집)」或「南浦 88 豬肉 (88돼지)」。",
        icon: "🥩",
        badges: ["3.5cm厚切熟成豬", "專人代烤", "黃金燒肉時段"],
        badgeType: "food",
        transport: "🚶 光復路商圈步行 3~5 分鐘 (費用 ₩0)",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=Matchandeul+Wangso-geum-gui+Bupyeong+Busan"
      },
      {
        time: "20:45 - 21:45",
        title: "散步與甜點：BIFF 廣場 & 富平夜市黑糖餅",
        desc: "吃完燒肉後，散步至相鄰的 BIFF 廣場品嚐「元祖堅果黑糖餅」作為完美的飯後甜點！逛完後搭計程車 5 分鐘回飯店休息。",
        icon: "🍡",
        badges: ["堅果黑糖餅", "飯後甜點"],
        badgeType: "food",
        transport: "🚶 燒肉店徒步 2 分鐘 / 🚕 回飯店計程車 5 分鐘 (車資 ₩5,000/台)",
...
const oyProductsData = [
  ...
  {"id": "yunjac", "time": "05:27", "name": "Yunjac 然植亞保濕底霜 (Base Prep)", "en_name": "Yunjac Skin Perfecting Protective Base Prep", "price_krw": "₩48,000 / 40ml", "price_twd": "約 NT$ 1,143", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "./images/oy/yunjac.jpg", "raw_img": "https://global.oliveyoung.com/search?query=Yunjac+Base+Prep&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=Yunjac+妝前", "features": "底妝膠水、防護隔離、透亮光澤", "skin_type": "乾性肌、混合偏乾、底妝容易浮粉起皮者", "reason": "高端草本護膚品牌推出的妝前精華。被譽為「乾皮親媽」與「化妝師的秘密武器」，質地如水般輕盈，能迅速覆平臉部角質，讓後續不論是粉底液還是氣墊粉餅都非常貼合，展現高級的水光感。", "tips": "在防曬後、底妝前，取 2-3 滴均勻塗抹於全臉，特別是易卡粉的鼻翼與兩頰，輕拍至微黏狀態再上底妝。", "badge": "美妝大賞第一"},
  ...
  {"id": "the_saem", "time": "07:12", "name": "The Saem 得鮮完美遮瑕液", "en_name": "The Saem Cover Perfection Tip Concealer", "price_krw": "₩6,500 / 6.5g", "price_twd": "約 NT$ 155", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "./images/oy/the_saem.jpg", "raw_img": "https://global.oliveyoung.com/search?query=The+Saem+Concealer&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=The+Saem+遮瑕液", "features": "極高遮瑕力、平價戰神、多色號選擇", "skin_type": "有痘疤、黑眼圈、班點需要高度遮瑕者", "reason": "風靡亞洲的平價遮瑕天王。遮瑕力強、持妝度極佳，不論是多深的痘疤 or 黑眼圈，輕點一下就能完美遮蓋，CP 值高到不可思議。", "tips": "因遮瑕力極高，質地偏乾，建議局部「點」在瑕瑕處，等 10 秒微乾後，再使用濕海綿或粉撲邊緣輕輕拍開。"},
  {"id": "about_tone", "time": "08:40", "name": "About Tone 柔焦控油蜜粉餅", "en_name": "About Tone Blur Powder Pact", "price_krw": "₩12,000 / 9g", "price_twd": "約 NT$ 286", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "./images/oy/about_tone.jpg", "raw_img": "https://global.oliveyoung.com/search?query=About+Tone+Blur+Powder+Pact&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=About+Tone+蜜粉餅", "features": "一秒磨皮、粉質極細、強效控油", "skin_type": "油性肌、混合肌、毛孔粗大者", "reason": "前身為風靡韓國的 Eglips 蜜粉餅。這款粉餅主打「空氣柔焦」效果，粉質如輕煙般細緻，能瞬間吸附皮脂，讓毛孔隱形，打造如陶瓷娃娃般的乾淨霧面妝效。", "tips": "使用附帶的粉撲，在底妝後輕壓在容易出油的 T 字部位、鼻翼，或用於眼周打底防暈染。"},
  {"id": "so_natural", "time": "09:55", "name": "So Natural 經典定妝噴霧", "en_name": "So Natural All Day Tight Makeup Setting Fixer", "price_krw": "₩16,000 / 75ml", "price_twd": "約 NT$ 380", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "./images/oy/so_natural.jpg", "raw_img": "https://global.oliveyoung.com/search?query=So+Natural+Fixer&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=So+Natural+定妝噴霧", "features": "細緻霧化、快速成膜、抗摩擦防脫妝", "skin_type": "所有膚質、混合偏油、需要長時間持妝者", "reason": "韓國定妝噴霧界的常勝冠軍，粉紅色瓶身非常具有代表性。其壓頭噴出的水霧極其細緻，不會在臉上結成水珠，能快速在底妝上形成保護膜，抗汗、抗油且防摩擦。", "tips": "化妝完成後，將噴霧距離臉部 20-30 公分，畫 'X' 和 'T' 字形噴灑全臉，靜待 1 分鐘自然風乾成膜，切勿用手拍打。"},
  {"id": "canmake", "time": "10:30", "name": "Canmake 腮紅霜", "en_name": "Canmake Cream Cheek", "price_krw": "₩11,000 / 4g", "price_twd": "約 NT$ 262", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "./images/oy/canmake.jpg", "raw_img": "https://global.oliveyoung.com/search?query=Canmake+Cream+Cheek&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=Canmake+腮紅霜", "features": "清透血色感、凝膠轉粉質、白裡透紅", "skin_type": "所有膚質，尤其是喜愛無粉感日韓系妝容者", "reason": "雖然是日系彩妝，但其極佳的自然融膚感在韓國 Olive Young 也擁有超高人氣。凝膠般的質地上臉推開後會化為乾爽的粉質，呈現如皮膚底層自然透出來 of 紅潤氣色。", "tips": "用手指沾取適量，輕點於蘋果肌處往外拍開，或是用氣墊粉撲上妝，效果更加均勻清透。"},
  {"id": "fillimilli", "time": "11:38", "name": "Fillimilli 胖胖氣墊粉撲", "en_name": "Fillimilli Cushion Pang Pang Puff", "price_krw": "₩5,000 / 2入", "price_twd": "約 NT$ 119", "category": "tools", "category_zh": "美妝工具", "img_url": "./images/oy/fillimilli.jpg", "raw_img": "https://global.oliveyoung.com/search?query=Fillimilli+Puff&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=Fillimilli+粉撲", "features": "厚實有彈性、上妝服貼、省時省粉底", "skin_type": "所有使用氣墊粉餅或粉底液的化妝者", "reason": "Olive Young 自有美妝配件品牌 Fillimilli 的明星產品。這款氣墊粉撲非常厚實，彈性極佳，能將粉底均勻且輕薄地拍入肌膚，大幅提升底妝的服貼度，是去 OY 必抓好幾個回台的貼心小物。", "tips": "可用於氣墊粉餅，也適合搭配普通粉底液使用。上妝時採用「快速拍打」的方式，能讓妝效更具光澤與遮瑕力。"},
  ...
  {"id": "peripera", "time": "14:09", "name": "Peripera 水光唇釉 (Ink Mood Glowy)", "en_name": "Peripera Ink Mood Glowy Tint", "price_krw": "₩10,000 / 4g", "price_twd": "約 NT$ 238", "category": "makeup", "category_zh": "彩妝與定妝", "img_url": "./images/oy/peripera.jpg", "raw_img": "https://global.oliveyoung.com/search?query=Peripera+Ink+Mood+Glowy+Tint&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=Peripera+水光唇釉", "features": "玻璃水光感、滋潤修飾唇紋、持久顯色", "skin_type": "唇紋明顯、喜愛水光嘟嘟唇與純欲妝效者", "reason": "平價彩妝之王 Peripera 的明星水光唇釉。上嘴後會形成一層晶瑩剔透的水光膜，質地保濕不乾澀，且帶有輕微的染唇效果，不容易完全掉色，是打造網紅玻璃唇的首選。", "tips": "塗抹於雙唇後，**靜待 1-2 分鐘不要抿嘴**，等它自動成膜後，水光感和持久度會大幅提升。"},
  {"id": "banila_co", "time": "15:14", "name": "Banila Co 緻柔卸妝膏", "en_name": "Banila Co Clean It Zero Cleansing Balm", "price_krw": "₩20,000 / 100ml", "price_twd": "約 NT$ 476", "category": "skincare", "category_zh": "臉部清潔", "img_url": "./images/oy/banila_co.jpg", "raw_img": "https://global.oliveyoung.com/search?query=Banila+Co+Clean+It+Zero&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=Banila+Co+卸妝膏", "features": "雪酪質地、秒乳化、溫和不緊繃", "skin_type": "所有膚質，包括敏感肌與日常化濃妝者", "reason": "風靡全球的「國民卸妝膏」。雪酪般的固體質地，接觸體體溫後會瞬間融化並乳化，能溫和、徹底地卸除所有頑固的防水彩妝與毛孔髒污，且洗後完全不熏眼、不緊繃。", "tips": "保持雙手和臉部乾燥，取適量卸妝膏塗抹於臉部輕柔按摩打圈，再沾取少量清水使其完全「乳化」變白，最後用溫水徹底沖洗乾淨。"},
  {"id": "teazen", "time": "16:29", "name": "Teazen 康普茶 (Kombucha)", "en_name": "Teazen Kombucha", "price_krw": "₩7,500 / 10條盒裝", "price_twd": "約 NT$ 178", "category": "lifestyle", "category_zh": "健康飲品", "img_url": "./images/oy/teazen.jpg", "raw_img": "https://global.oliveyoung.com/search?query=Teazen+Kombucha&lang=zh_TW", "momo_url": "https://m.momoshop.com.tw/search.momo?searchKeyword=Teazen+康普茶", "features": "低卡無糖、富含益生菌、清爽氣泡感", "skin_type": "注重腸道健康、想戒含糖飲料的健康追求者", "reason": "因為 BTS 成員飲用而火遍全韓的健康機能飲品。採用凍乾技術保留乳酸菌與益生元，沖泡後帶有碳酸微氣泡感，口味酸甜清爽（如檸檬、水蜜桃等），一包熱量僅 15 卡，解膩無負擔。", "tips": "用 250ml - 500ml 的冷水或冰水沖泡，氣泡感會更加強烈，喝起來就像健康的汽水，非常適合作為大餐後的消食飲料。"}
];
